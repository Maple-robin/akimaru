document.addEventListener('DOMContentLoaded', function() {
    ...
    let products = [
        {
            id: 1,
            name: '純米大吟醸 吟醸の雫',
            image: 'https://placehold.co/300x200/F8F8FF/000000?text=JunmaiDaiginjo',
            volume: '720ml',
            price: 5000,
            tags: ['辛口', 'フルーティー', '高級'],
            category: '日本酒',
        ...
        },
        {
            id: 2,
            name: '特別純米酒 匠の技',
            image: 'https://placehold.co/300x200/E0FFFF/000000?text=TokubetsuJunmai',
            volume: '720ml',
            price: 3000,
            tags: ['中口', 'バランス', '定番'],
            category: '日本酒',
        ...
        },
        {
            id: 3,
            name: '純米吟醸 華やか',
            image: 'https://placehold.co/300x200/F5DEB3/000000?text=JunmaiGinjo',
            volume: '720ml',
            price: 4000,
            tags: ['甘口', '華やか', '初心者向け'],
            category: '日本酒',
        ...
        },
        {
            id: 4,
            name: '本醸造 辛口',
            image: 'https://placehold.co/300x200/B0C4DE/000000?text=Honjozo',
            volume: '1800ml',
            price: 2500,
            tags: ['辛口', 'キレ', '晩酌'],
            category: '日本酒',
        ...
        },
        {
            id: 5,
            name: 'にごり酒 雪の舞',
            image: 'https://placehold.co/300x200/F0FFF0/000000?text=Nigorizake',
            volume: '720ml',
            price: 2800,
            tags: ['甘口', 'にごり', '珍しい'],
            category: '日本酒',
        ...
        },
        {
            id: 6,
            name: '生酒 フレッシュ',
            image: 'https://placehold.co/300x200/FFFAF0/000000?text=Namazake',
            volume: '720ml',
            price: 3500,
            tags: ['フレッシュ', '限定', '要冷蔵'],
            category: '日本酒',
    ...
    function applyFiltersAndSort() {
        ...
        if (currentFilters.categories.length > 0 && !currentFilters.categories.includes('すべて')) {
            ...
            // どのカテゴリも選択されていない場合は、デフォルトで「日本酒」を表示
            filteredProducts = filteredProducts.filter(product => product.category === '日本酒');
        }
    ...
    applyFilterButton.addEventListener('click', () => {
        ...
        if (currentFilters.categories.includes('すべて')) {
            ...
            // どのカテゴリも選択されていない場合、デフォルトで「日本酒」を選択
            currentFilters.categories = ['日本酒'];
            // フィルターパネルの「日本酒」チェックボックスもチェックする
            document.querySelector('#filter-overlay input[name="category"][value="日本酒"]').checked = true;
        }
    ...
    // 初期レンダリング
    // ページロード時に「日本酒」カテゴリのチェックボックスを自動でチェック
    const sakeCategoryCheckbox = document.querySelector('#filter-overlay input[name="category"][value="日本酒"]');
    if (sakeCategoryCheckbox) {
        sakeCategoryCheckbox.checked = true;
    }
    applyFiltersAndSort();
});
