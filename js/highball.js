document.addEventListener('DOMContentLoaded', function() {
    ...
    let products = [
        {
            id: 1,
            name: '定番ウイスキーハイボール',
            image: 'https://placehold.co/300x200/D2B48C/000000?text=WhiskyHighball',
            volume: '350ml',
            price: 480,
            tags: ['定番', '辛口', '度数高め'],
            category: 'ハイボール',
        ...
        },
        {
            id: 2,
            name: 'レモンハイボール',
            image: 'https://placehold.co/300x200/F0E68C/000000?text=LemonHighball',
            volume: '350ml',
            price: 500,
            tags: ['爽やか', '初心者向け'],
            category: 'ハイボール',
        ...
        },
        {
            id: 3,
            name: 'ジンジャーハイボール',
            image: 'https://placehold.co/300x200/CD853F/000000?text=GingerHighball',
            volume: '350ml',
            price: 520,
            tags: ['スパイシー', '個性派'],
            category: 'ハイボール',
        ...
        },
        {
            id: 4,
            name: 'ピーチハイボール',
            image: 'https://placehold.co/300x200/FFDAB9/000000?text=PeachHighball',
            volume: '350ml',
            price: 550,
            tags: ['甘口', '初心者向け'],
            category: 'ハイボール',
        ...
        },
        {
            id: 5,
            name: 'コークハイボール',
            image: 'https://placehold.co/300x200/A0522D/FFFFFF?text=CokeHighball',
            volume: '350ml',
            price: 490,
            tags: ['定番', '甘口'],
            category: 'ハイボール',
        ...
        },
        {
            id: 6,
            name: '柚子ハイボール',
            image: 'https://placehold.co/300x200/FFEFD5/000000?text=YuzuHighball',
            volume: '350ml',
            price: 580,
            tags: ['和風', '爽やか'],
            category: 'ハイボール',
    ...
    function applyFiltersAndSort() {
        ...
        if (currentFilters.categories.length > 0 && !currentFilters.categories.includes('すべて')) {
            ...
            // どのカテゴリも選択されていない場合は、デフォルトで「ハイボール」を表示
            filteredProducts = filteredProducts.filter(product => product.category === 'ハイボール');
        }
    ...
    applyFilterButton.addEventListener('click', () => {
        ...
        if (currentFilters.categories.includes('すべて')) {
            ...
            // どのカテゴリも選択されていない場合、デフォルトで「ハイボール」を選択
            currentFilters.categories = ['ハイボール'];
            // フィルターパネルの「ハイボール」チェックボックスもチェックする
            document.querySelector('#filter-overlay input[name="category"][value="ハイボール"]').checked = true;
        }
    ...
    // 初期レンダリング
    // ページロード時に「ハイボール」カテゴリのチェックボックスを自動でチェック
    const highballCategoryCheckbox = document.querySelector('#filter-overlay input[name="category"][value="ハイボール"]');
    if (highballCategoryCheckbox) {
        highballCategoryCheckbox.checked = true;
    }
    applyFiltersAndSort();
});
